    ...
    <header className="fixed top-0 w-full z-50 border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-sm dark:bg-slate-900/95 dark:border-slate-800">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 h-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="font-sans text-sm font-medium px-4 py-2 text-slate-600 hover:bg-slate-50 rounded-lg transition-all active:scale-95 dark:text-slate-300 dark:hover:bg-slate-800">
            Sign In
          </button>

          <button className="font-sans text-sm font-medium px-5 py-2.5 bg-blue-600 text-white rounded-2xl shadow-sm hover:bg-blue-700 transition-all active:scale-95">
            List Property
          </button>
        </div>
      </div>
